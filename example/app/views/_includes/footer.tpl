        <footer>
            <nav class="container">
                ...
                {% if (count($app->languages) > 1): %}
                    <div class="locale">
                        <a href="#" data-trigger="dropdown" title="{{'Select Language'}}"><i class="fas fa-globe"></i> {% echo _($account->meta->language ?? $app->language); %} <i class="fas fa-angle-down"></i></a>
                        <div class="dropdown">
                            ...
                            <ul>
                                {% foreach($app->languages as $value): %}
                                    <li><a href="#" data-request="account/locale" data-value="{{$value}}">{% echo _($value); %}</a></li>
                                {% endforeach; %}
                            </ul>
                        </div>
                    </div>
